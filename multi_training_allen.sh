...
# export PATH=/allen/programs/mindscope/workgroups/realistic-model/beatriz.herrera/miniconda3/envs/tf2/bin:$PATH
# source /allen/programs/mindscope/workgroups/realistic-model/beatriz.herrera/miniconda3/bin/activate tf2
...
# python parallel_training_testing.py --neurons 65871 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --delays 0,0 --reset_every_step --train_recurrent --osi_loss_method 'crowd_osi' --osi_cost 10 --rate_cost 10000 --voltage_cost 1 --recurrent_weight_regularization 1 --learning_rate 0.001 --n_runs 10 --n_epochs 50 --steps_per_epoch 20
# python parallel_training_testing_allen.py --neurons 65871 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --delays 0,0 --reset_every_step --train_recurrent --osi_loss_method 'crowd_osi' --osi_cost 10 --rate_cost 10000 --voltage_cost 1 --recurrent_weight_regularization 1 --learning_rate 0.001 --n_runs 10 --n_epochs 50 --steps_per_epoch 50

python parallel_training_testing_allen.py --neurons 65870 --seed 1918 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --delays 0,0 --train_recurrent --osi_loss_method 'crowd_osi' --osi_cost 10 --rate_cost 10000 --voltage_cost 1 --recurrent_weight_regularization 1 --sync_cost 0.3 --learning_rate 0.001 --n_runs 20 --n_epochs 50 --steps_per_epoch 25 --train_noise

# python parallel_training_testing_allen.py --neurons 65871 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --delays 0,0 --train_recurrent --osi_loss_method 'crowd_osi' --osi_cost 10 --rate_cost 10000 --voltage_cost 1 --recurrent_weight_regularization 1 --sync_cost 0.0 --learning_rate 0.001 --n_runs 20 --n_epochs 50 --steps_per_epoch 25 --train_noise
# python parallel_training_testing_allen.py --neurons 65871 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --delays 0,0 --train_recurrent --osi_loss_method 'crowd_osi' --osi_cost 10 --rate_cost 10000 --voltage_cost 1 --recurrent_weight_regularization 1 --sync_cost 0.3 --learning_rate 0.001 --n_runs 20 --n_epochs 50 --steps_per_epoch 25 --train_noise --restore_from 'Simulation_results/v1_65871/b_1zvn/OSI_DSI_checkpoints'
# python parallel_training_testing_allen.py --neurons 65871 --seq_len 500 --loss_core_radius 200 --plot_core_radius 200 --delays 0,0 --train_recurrent --osi_loss_method 'crowd_osi' --osi_cost 10 --rate_cost 10000 --voltage_cost 1 --recurrent_weight_regularization 1 --sync_cost 0.3 --learning_rate 0.001 --n_runs 20 --n_epochs 50 --steps_per_epoch 25 --train_noise --restore_from 'Simulation_results/v1_65871/b_1zvn/OSI_DSI_checkpoints'
